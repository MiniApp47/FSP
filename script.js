  ...
  const contactLinks = [
    ...
    const appData = [
        ...
        // ============================================================
        {
            ...
            image: 'CategWeed.png', 
            farms: [
                { id: 'ESPAGNOL', name: 'Espagnol 🇪🇸', image: '', badgeText: '', products: [
                    {
                            id: 'Purple',
                            flag: '🇲🇦',
                            name: 'Purple 🫐',
                ...
                { id: 'HOLLANDAISE', name: 'Hollandaise 🇳🇱', image: '', badgeText: '', products: [] }
            ]
        },
        // ============================================================
        // CATEGORIE 2 : HASH 🍫
        // ============================================================
        {
            ...
            image: 'CategHash.png',
            farms: [
                { id: 'JAUNE_MOUSSEUX', name: 'Jaune Mousseux 🍯', image: '', badgeText: '', products: [] },
                { id: 'DRY', name: 'Dry 🏜️', image: '', badgeText: '', products: [] }
            ]
        },
        {
            id: 'HASH USA',
        ...
        // ============================================================
        {
            ...
            farms: [
                { id: '120U', name: '120u ✨', image: '', badgeText: '', products: [
                    {
                ...
                { id: '90U', name: '90u 💎', image: '', badgeText: '', products: [
                    {
                            id: 'happy',
                            flag: '🇲🇦',
                            name: 'Happy 🎃',
                ...
                { id: '73U', name: '73u 👑', image: '', badgeText: '', products: [] }
            ]
        },
        // ============================================================
        // CATEGORIE 4 : FROZEN ❄️ (Pas de sous-catégorie)
        // ============================================================
        {
            id: 'FROZEN',
            name: '❄️ FROZEN',
            type: 'Frozen',
            quality: '❄️ Fresh Frozen',
        ...
        // ============================================================
        {
           ...
           /*  farms: [
                { id: 'DOUBLE_STATIC', name: 'Double Static ⚡⚡', image: '', badgeText: '', products: [] },
                { id: 'PLASMA_STATIC', name: 'Plasma Static 🌌', image: '', badgeText: '', products: [] }
            ] */
        },
        // ============================================================
        // CATEGORIE 6 : BLANCHE 🤍 (Pas de sous-catégorie)
        // ============================================================
        {
            id: 'BLANCHE',
            name: 'BLANCHE 🤍',
            ...
            products: [] // Les produits s'insèrent directement ici
        }
    ];
...
if (target.closest('#confirm-telegram')) {
    const totalItems = cart.reduce((sum, item) => sum + item.quantity, 0);
    ...
    // Ouvre Telegram et pré-remplit le message de commande automatiquement
const telegramId = "fastsafepremium"; 
    const telegramUrl = `https://t.me/${telegramId}?text=${encodedMessage}`;
    ...
    tg.openLink(telegramUrl);}
        ...
        if (target.closest('#confirm-snapchat')) {
            ...
            const snapchatUrl = 'https://snapchat.com/t/eX8ZP9rG';
            let message = formatOrderMessage();
